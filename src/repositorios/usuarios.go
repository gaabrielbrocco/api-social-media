...
// conexão com o banco aberta no controller e passada para o struct, que faz a interação com o banco
...
// busca um usuario por email e retorna seu id e senha com hash
...
func (repositorio Usuarios) BuscarSeguindo(usuarioID uint64) ([]modelos.Usuario, error) {
	linhas, erro := repositorio.db.Query(`
		select u.id, u.nome, u.id, u.email, u.criadoEm
