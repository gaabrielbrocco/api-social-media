...
// traz as publicações dos usuários seguidos e tambem do proprio usuario que fez a requisição
...
// altera os dados de uma publicacao no banco de dados
...
// traz todas publicacoes de um usuário específico
